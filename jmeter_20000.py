...
plus_values = [0, 17, 27]  # Values for the '+' column
minus_values = [7, 24, 35]  # Values for the '-' column
...
ax.set_title('JMeter Benchmark - 20000 Requests')
ax.set_xticks(x)
...
# Save the plot
plt.savefig('histogram/jmeter_20000_requests.png')
